...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__forms_validationforms_password_validator_component__ = __webpack_require__("./src/app/forms/validationforms/password-validator.component.ts");
...
var MyProfileComponent = /** @class */ (function () {
    function MyProfileComponent(http, router, commonService, userService, countryService, formBuilder) {
        ...
        this.myProfilePage = new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormGroup"]({
            ...
            confirmPassword: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"]()
        });
        this.errorMsg = null;
    ...
    MyProfileComponent.prototype.ngOnInit = function () {
        if (JSON.parse(sessionStorage.getItem('LogEmployee')) != null) {
            ...
            this.myProfilePage = this.formBuilder.group({
                ...
                validator: __WEBPACK_IMPORTED_MODULE_8__forms_validationforms_password_validator_component__["a" /* PasswordValidation */].MatchPassword // your validation method
            });
            $('.loader').show();
            this.setProfileData();
        }
    ...
    MyProfileComponent.prototype.setProfileData = function () {
        if (JSON.parse(sessionStorage.getItem('LogEmployee')) != null) {
            ...
            this.myProfilePage.controls["confirmPassword"].setValue(this.userProfile.Password);
            ...
            document.getElementById('division').innerHTML = this.userProfile.DivisionName; //this.userProfile.DivisionId == 1 ? "All" : this.userProfile.DivisionId == 2 ? "Aspect Toowoomba" : this.userProfile.DivisionId == 3 ? "Toowoomba Bench Tops" : "Bradbec";
