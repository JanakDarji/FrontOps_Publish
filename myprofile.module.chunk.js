...
var MyProfileComponent = /** @class */ (function () {
    ...
    MyProfileComponent.prototype.ngOnInit = function () {
        ...
        this.myProfilePage = this.formBuilder.group({
            ...
            division: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required],
    ...
    MyProfileComponent.prototype.createUser = function () {
        ...
        if (this.myProfilePage.valid) {
            ...
            var contact = {
                ...
                DivisionId: this.myProfilePage.controls["division"].value,
