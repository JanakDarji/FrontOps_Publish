...
var JobsComponent = /** @class */ (function () {
    ...
    JobsComponent.prototype.getRoleBasedJobClient = function () {
        var _this = this;
        $('.loader').show();
        this.jobService.GetRoleBasedJobClient(this.commonService.baseApiUrl, this.userProfile.ID).subscribe(function (data) {
