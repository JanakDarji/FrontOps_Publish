    ...
    ChecklistFormComponent.prototype.ngOnInit = function () {
        if (JSON.parse(sessionStorage.getItem('LogEmployee')) != null) {
            ...
            this.checklistFormDataTable = {
                chklistFormHeaderRow: ['#', 'Form Name', 'Form Description', 'Last Updated', 'Updated By', 'Status', 'Actions'],
                chklistFormFooterRow: ['#', 'Form Name', 'Form Description', 'Last Updated', 'Updated By', 'Status', 'Actions'],
