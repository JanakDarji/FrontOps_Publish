    ...
    ChecklistFormComponent.prototype.ngOnInit = function () {
        if (JSON.parse(sessionStorage.getItem('LogEmployee')) != null) {
            ...
            this.checklistFormDataTable = {
                chklistFormHeaderRow: ['#', 'Form Name', 'WOs', 'Form Description', 'Last Updated', 'Updated By', 'Status', 'Actions'],
                chklistFormFooterRow: ['#', 'Form Name', 'WOs', 'Form Description', 'Last Updated', 'Updated By', 'Status', 'Actions'],
...
var CreateChecklistformComponent = /** @class */ (function () {
    function CreateChecklistformComponent(http, router, commonService, checklistformService, maintenanceService, activatedRoute, formBuilder) {
        ...
        this.chkIsActForm = new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormGroup"]({
    ...
    CreateChecklistformComponent.prototype.ngOnInit = function () {
        ...
        if (JSON.parse(sessionStorage.getItem('LogEmployee')) != null) {
            ...
            this.chkIsActForm = this.formBuilder.group({
                chkActive: null
            });
    ...
    CreateChecklistformComponent.prototype.getWorkOrders = function () {
        ...
        this.maintenanceService.GetWorkOrderForMaintenance(this.commonService.baseApiUrl, this.userProfile.ID).subscribe(function (data) {
            ...
            if (userInfo != null) {
                ...
                //localStorage.setItem("AutoWorkOrdList", JSON.stringify(this.autoWorkOrdList));
                $('.loader').hide();
            }
        });
    };
    CreateChecklistformComponent.prototype.createChecklistForm = function (status) {
        ...
        if (this.chklistForm.controls["workOrdNo"].value == undefined || this.chklistForm.controls["workOrdNo"].value == '') {
            localStorage.removeItem("workOrdID");
        }
        $('.loader').show();
        ...
        if (this.chklistForm.valid && this.errorMsg == null) {
            ...
            var contact = {
                ...
                WorkOrderID: (this.selectedWOrd != undefined && this.selectedWOrd != null) ? this.selectedWOrd : localStorage.getItem("workOrdID"),
                LastUpdated: null,
            ...
            this.checklistformService.CreateCheckListForm(this.commonService.baseApiUrl, contact).subscribe(function (data) {
                ...
                if (formInfo != -1) {
                    $('.loader').hide();
                    _this.saveButton.nativeElement.disabled = false;
    ...
    CreateChecklistformComponent.prototype.updateCheckListFormStatus = function () {
        this.chklistformStatus = this.chkIsActForm.controls["chkActive"].value == true ? "Active" : (this.checkformData.Status == 2 ? "InActive" : "Draft");
        $('.loader').show();
        if (this.chkIsActForm.valid) {
            var crntUsr = JSON.parse(sessionStorage.getItem('LogEmployee'));
            var contact = {
                ID: this.chkfomrId,
                LastUpdated: null,
                UpdatedBy: crntUsr.ID,
                Status: this.chkIsActForm.controls["chkActive"].value == true ? 1 : 2
            };
            ...
            $('.loader').hide();
            this.validateAllFormFields(this.chkIsActForm);
        }
    };
    ...
    CreateChecklistformComponent.prototype.goToChecklistForm = function () {
        this.router.navigate(['settings/checklist-form']);
    };
    CreateChecklistformComponent.prototype.buttonEditClick = function () {
        ...
        return this.checklistformService.GetCheckListFormByID(this.commonService.baseApiUrl, contact).subscribe(function (data) {
            ...
            if (mTList != null) {
                ...
                if (_this.checkformData.WorkOrderID != null) {
                    localStorage.setItem("workOrdID", _this.checkformData.WorkOrderID);
                    _this.chklistForm.controls["workOrdNo"].setValue(_this.checkformData.WorkOrderNo);
                }
                else {
                ...
                _this.chkIsActForm.controls["chkActive"].setValue(_this.checkformData.Status == 1 ? true : false);
        ...
        if (this.formTask.valid) {
            ...
            this.checklistformService.CreateNewTask(this.commonService.baseApiUrl, this.chkfomrId + '-' + JSON.parse(sessionStorage.getItem('LogEmployee')).ID, contact).subscribe(function (data) {
                ...
                if (userInfo == 1) {
                    ...
                    //this.showStaySwal("New task has been created.");
                    _this.getTasks(_this.chkfomrId);
                }
    ...
    ], CreateChecklistformComponent.prototype, "saveButton", void 0);
        ...
        if (this.formMaintenance.valid && this.errorMTypeMsg == null) {
            ...
            return this.maintenanceService.CreateMaintenanceType(this.commonService.baseApiUrl, contact).subscribe(function (data) {
                ...
                if (mTpList == true) {
                    ...
                    //    this.showSwal("Maintenance Type has been updated successfully!");
                    //}
                    //else {
                    //    this.showSwal("Maintenance Type has been created successfully!");
                    //}
                }
            });
        }
        ...
        if (this.formPartMaintenance.valid && this.errorMPTypeMsg == null) {
            ...
            return this.maintenanceService.CreateMaintenancePartType(this.commonService.baseApiUrl, contact).subscribe(function (data) {
                ...
                if (mTpList == true) {
                    ...
                    //    this.showSwal("Maintenance Part Type has been updated successfully!");
                    //}
                    //else {
                    //    this.showSwal("Maintenance Part Type has been created successfully!");
                    //}
                }
            });
        }
