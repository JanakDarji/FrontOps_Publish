        ...
        if (this.login.valid) {
            ...
            this.loginService.EmployeeLogin(this.commonService.baseApiUrl, empEmail, empPassword).subscribe(function (data) {
                ...
                if (empParse["_body"] != 'null') {
                    if (eplDetail.ErrorMessage != null) {
                        _this.loginErr = eplDetail.ErrorMessage;
                        $('.loader').hide();
                    }
                    else {
