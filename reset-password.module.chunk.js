...
var ResetPasswordComponent = /** @class */ (function () {
    ...
    ResetPasswordComponent.prototype.ngOnInit = function () {
        ...
        this.resetReq = this.formBuilder.group({
            email: [null, [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["Validators"].pattern("^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$")]]
        });
