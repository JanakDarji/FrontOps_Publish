    ...
    ViewTimesheetComponent.prototype.getWorkOrderDetails = function (asgtID) {
        ...
        this.timesheetService.GetTimesheetTrack(this.commonService.baseApiUrl, asgtID).subscribe(function (data) {
            ...
            if (tSheetList != null) {
                ...
                var address = tSheetList.AddressLine1 + tSheetList.AddressLine2 + tSheetList.AddressLine3 + tSheetList.Town + tSheetList.State + tSheetList.PostalCode;
                if (address != null) {
                    _this.jobAddress = address.slice(0, -1);
                }
