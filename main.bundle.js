...
var SidebarComponent = /** @class */ (function () {
    function SidebarComponent(router, loginService, notificationService, commonService) {
        this.router = router;
    ...
    SidebarComponent.prototype.getNotification = function () {
        var _this = this;
        $('.loader').show();
        this.notificationService.GetNotification(this.commonService.baseApiUrl, this.logEmployee.ID).subscribe(function (data) {
            var dataNft = JSON.stringify(data);
    ...
    SidebarComponent.prototype.updateNotification = function (notID) {
        var _this = this;
        $('.loader').show();
        this.notificationService.UpdateNotification(this.commonService.baseApiUrl, notID, this.logEmployee.ID).subscribe(function (data) {
            var datawAsg = JSON.stringify(data);
    ...
    SidebarComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_3__services_loginService__["a" /* LoginService */], __WEBPACK_IMPORTED_MODULE_5__services_commonService__["a" /* CommonService */], __WEBPACK_IMPORTED_MODULE_4__services_notificationService__["a" /* NotificationService */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_router__["d" /* Router */],
            __WEBPACK_IMPORTED_MODULE_3__services_loginService__["a" /* LoginService */],
            __WEBPACK_IMPORTED_MODULE_4__services_notificationService__["a" /* NotificationService */],
            __WEBPACK_IMPORTED_MODULE_5__services_commonService__["a" /* CommonService */]])
    ], SidebarComponent);
