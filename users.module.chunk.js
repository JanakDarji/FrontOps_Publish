...
var UsersComponent = /** @class */ (function () {
    function UsersComponent(http, router, commonService, userService, countryService, roleService, schedulerService, divisionService, timer) {
        ...
        this.stageUser = new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormGroup"]({
            ...
            company: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"]()
        });
    }
    ...
    UsersComponent.prototype.ngOnInit = function () {
        if (JSON.parse(sessionStorage.getItem('LogEmployee')) != null) {
            ...
            this.getAllEmployee();
            this.dataTable = {
                headerRow: ['User', 'Email Address', 'Phone Number', 'Division', 'Role', 'Status', 'Actions'],
                footerRow: ['User', 'Email Address', 'Phone Number', 'Division', 'Role', 'Status', 'Actions'],
    ...
    UsersComponent.prototype.createUser = function () {
        ...
        var contact = {
            ...
            CompanyName: this.stageUser.controls["company"].value,
        };
        ...
        if (userList != null) {
            for (var _i = 0, userList_1 = userList; _i < userList_1.length; _i++) {
                ...
                if (userID == oldEmpID) {
                    ...
                    this.mapUserList.edcompany = emp.CompanyName;
                    this.mapUserList.company = emp.CompanyName;
                    ...
                    this.stageUser.controls["company"].setValue(emp.CompanyName);
    ...
    UsersComponent.prototype.getAllEmployee = function () {
        ...
        this.userService.GetSyncEmployee(this.commonService.baseApiUrl).subscribe(function (data) {
            ...
            if (empList != null) {
                ...
                var newUsers = empList.filter(function (usr) { return usr.UserStatus == "New"; });
                _this.noOfUser = newUsers.length;
    ...
    UsersComponent.prototype.getDivision = function () {
        var _this = this;
        return this.divisionService.GetDivisionForCalendar(this.commonService.baseApiUrl, this.userProfile.ID).subscribe(function (data) {
            var dataEmp = JSON.stringify(data);
            var empParse = JSON.parse(dataEmp);
