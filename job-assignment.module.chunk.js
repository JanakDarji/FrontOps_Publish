...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_sweetalert2__ = __webpack_require__("./node_modules/sweetalert2/dist/sweetalert2.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__forms_validationforms_password_validator_component__ = __webpack_require__("./src/app/forms/validationforms/password-validator.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var JobAssignmentComponent = /** @class */ (function () {
    function JobAssignmentComponent(mapsAPILoader, ngZone, http, router, activatedRoute, commonService, workOrderService, userService, _sanitizer, formBuilder, dateAdapter) {
        ...
        this.uploader = new __WEBPACK_IMPORTED_MODULE_11_ng2_file_upload__["FileUploader"]({ url: this.commonService.baseApiUrl + "AddWorkOrderDocuments/", itemAlias: 'file' });
    ...
    JobAssignmentComponent.prototype.showSwal = function (text) {
        ...
        }).catch(__WEBPACK_IMPORTED_MODULE_10_sweetalert2___default.a.noop);
    };
    ...
    JobAssignmentComponent.prototype.ngOnInit = function () {
        ...
        this.workOrdAssPage = this.formBuilder.group({
            ...
            validator: __WEBPACK_IMPORTED_MODULE_12__forms_validationforms_password_validator_component__["a" /* PasswordValidation */].DateValidation // your validation method
        });
    };
    ...
    JobAssignmentComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__services_commonService__["a" /* CommonService */], __WEBPACK_IMPORTED_MODULE_6__services_workOrderService__["a" /* WorkOrderService */], __WEBPACK_IMPORTED_MODULE_5__services_userService__["a" /* UserService */]],
            styles: ["md-calendar {\n      width: 300px;\n  }"]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_8__agm_core__["b" /* MapsAPILoader */],
            ...
            __WEBPACK_IMPORTED_MODULE_7__angular_material__["a" /* DateAdapter */]])
