...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_sweetalert2__ = __webpack_require__("./node_modules/sweetalert2/dist/sweetalert2.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__forms_validationforms_password_validator_component__ = __webpack_require__("./src/app/forms/validationforms/password-validator.component.ts");
...
var WoAssignmentComponent = /** @class */ (function () {
    function WoAssignmentComponent(mapsAPILoader, ngZone, http, router, activatedRoute, commonService, workOrderService, activityService, maintenanceService, userService, _sanitizer, formBuilder, dateAdapter, datepipe) {
        ...
        this.uploader = new __WEBPACK_IMPORTED_MODULE_13_ng2_file_upload__["FileUploader"]({ url: this.commonService.baseApiUrl + "AddWorkOrderDocuments/", itemAlias: 'file' });
    ...
    WoAssignmentComponent.prototype.showSwal = function (text) {
        ...
        }).catch(__WEBPACK_IMPORTED_MODULE_12_sweetalert2___default.a.noop);
    };
    ...
    WoAssignmentComponent.prototype.ngOnInit = function () {
        ...
        if (JSON.parse(sessionStorage.getItem('LogEmployee')) != null) {
            ...
            this.workOrdAssPage = this.formBuilder.group({
                ...
                validator: __WEBPACK_IMPORTED_MODULE_14__forms_validationforms_password_validator_component__["a" /* PasswordValidation */].DateValidation // your validation method
            });
        }
        else {
    ...
    WoAssignmentComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_10__agm_core__["c" /* MapsAPILoader */],
            ...
            __WEBPACK_IMPORTED_MODULE_9__angular_material__["a" /* DateAdapter */],
            __WEBPACK_IMPORTED_MODULE_15__angular_common__["DatePipe"]])
