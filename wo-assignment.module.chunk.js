...
var WoAssignmentComponent = /** @class */ (function () {
    ...
    WoAssignmentComponent.prototype.getChecklistFormWOAssignmentTaskAnswer = function () {
        var _this = this;
        $('.loader').show();
        this.checklistformService.GetChecklistFormWOAssignmentTaskAnswer(this.commonService.baseApiUrl, localStorage.getItem("WorkOrderId")).subscribe(function (data) {
            var datawAsg = JSON.stringify(data);
            var wAsgParse = JSON.parse(datawAsg);
            var wAsgList = JSON.parse(wAsgParse["_body"]);
